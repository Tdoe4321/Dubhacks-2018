...
public class GearVRPointer : MonoBehaviour {
	...
	public Transform ControllerTransform {
		get {
			...
			if (controller == OVRInput.Controller.LTrackedRemote || controller == OVRInput.Controller.LTouch) {
				return leftHandAnchor;
			} else if (controller == OVRInput.Controller.RTrackedRemote || controller == OVRInput.Controller.RTouch) {
	...
	void Update() {
		...
		if (Physics.Raycast (pointer, out hit, maxRayDistance, ~excludeLayers)) {
            ...
            if (controller != OVRInput.Controller.None) {
				if (OVRInput.GetDown(OVRInput.Button.PrimaryTouchpad, controller) || OVRInput.GetDown(OVRInput.Button.PrimaryThumbstick, controller)) {
					padDown = lastHit;
				}
				else if (OVRInput.GetUp(OVRInput.Button.PrimaryTouchpad, controller) || OVRInput.GetUp(OVRInput.Button.PrimaryThumbstick, controller)) {
				...
				if (!(OVRInput.Get(OVRInput.Button.PrimaryTouchpad, controller) || !OVRInput.Get(OVRInput.Button.PrimaryThumbstick, controller))) {
					padDown = null;
				}
