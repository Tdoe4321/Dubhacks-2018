...
public class NoController : MonoBehaviour {
    ...
    protected OVRInput.Controller touchLeft = OVRInput.Controller.LTouch;
    protected OVRInput.Controller touchRight = OVRInput.Controller.RTouch;
	...
	void Update()
	{
		bool controllerConnected =
            OVRInput.IsControllerConnected(left) || OVRInput.IsControllerConnected(right) ||
            OVRInput.IsControllerConnected(touchLeft) || OVRInput.IsControllerConnected(touchRight);
